...
DAG_ID = 'amundsen_databuilder_athena'
...
SUPPORTED_SCHEMAS = ['ml_db']
SUPPORTED_SCHEMA_SQL_IN_CLAUSE = "('{schemas}')".format(schemas="', '".join(SUPPORTED_SCHEMAS))

OPTIONAL_TABLE_NAMES = ''
FOLDER_ATHENA_RESULTS = 's3_staging_dir=s3://aws-athena-query-results-032106861074-us-east-1/'
AWS_ACCESS = ''
AWS_SECRET = ''
